...
// import mobcareer from "../assets/careers/Mask Group 46.png";
import mobcareer from "../assets/careers/carrer mob.png";
...
const CareersBanner = () => {
  return (
    <div className=" relative">
      ...
      />
      {/* --- */}
      <div className="pageBannerH1 absolute xs:top-[40%] ssx:top-[41%] sg:top-[43%] md:top-[43%] ep:top-[45%] lg:top-[44%] xl:top-[48%] xm:top-[44%] xll:top-[45%] 2xl:top-[47%] text-white text-[24px] w-[100%] xs:px-[1rem] ssx:px-[1.4rem] sg:px-[2rem] md:px-[6rem] xs:text-center">
