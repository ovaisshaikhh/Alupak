...
import productBanner from "../assets/pb.png";
import mobProductbanner from "../assets/pbmob.png"
// import bh from "../assets/"
...
const ProductBanner = () => {
  return (
    <div className="relative">
      <img className="w-[100vw] xs:hidden md:block" src={productBanner} alt="banner" />
      <img className="w-[100vw] xs:block md:hidden h-[50vh]" src={mobProductbanner} alt="banner" />
